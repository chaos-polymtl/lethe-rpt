...
void LagrangianPhysicalProperties::declare_parameters(
  ...
  prm.enter_subsection("lagrangian physical properties");
  {
    ...
    prm.declare_entry("g", "0., 0., 0.", Patterns::List(Patterns::Double()),
                      "Gravitational acceleration vector");
    prm.declare_alias("g", "gx", true);
    prm.declare_entry("gy", "0.", Patterns::Double(),
                      "Gravitational acceleration in y direction (deprecated, "
                      "use <g> as vector)");
    prm.declare_entry("gz", "0.", Patterns::Double(),
                      "Gravitational acceleration in z direction (deprecated, "
                      "use <g> as vector)");

    prm.declare_entry("number of particle types", "1", Patterns::Integer(),
    ...
    prm.declare_entry("young modulus wall", "1000000.", Patterns::Double(),
                      "Young's modulus of wall");
    prm.declare_entry("poisson ratio wall", "0.3", Patterns::Double(),
                      "Poisson's ratio of wall");
    prm.declare_entry("restitution coefficient wall", "0.1", Patterns::Double(),
                      "Coefficient of restitution of wall");
    prm.declare_entry("friction coefficient wall", "0.1", Patterns::Double(),
                      "Friction coefficient of wall");
    prm.declare_entry("rolling friction wall", "0.1", Patterns::Double(),
                      "Rolling friction coefficient of wall");
    prm.declare_entry("rolling viscous damping wall", "0.1", Patterns::Double(),
                      "Rolling viscous damping wall");
    prm.declare_entry("surface energy wall", "0.0", Patterns::Double(),
                      "Surface energy of wall");
    prm.declare_entry("hamaker constant wall", "4.e-19", Patterns::Double(),
                      "Hamaker constant of wall");
    prm.declare_entry("thermal conductivity wall", "100", Patterns::Double(),
                      "Thermal conductivity of wall");
    prm.declare_entry("microhardness wall", "1.e9", Patterns::Double(),
                      "Microhardness of wall");
    prm.declare_entry("surface slope wall", "0.1", Patterns::Double(),
                      "Surface slope of wall");
    prm.declare_entry("surface roughness wall", "1.e-10", Patterns::Double(),
                      "Surface roughness of wall");
    prm.declare_entry("thermal accommodation wall", "0.7", Patterns::Double(),
                      "Thermal accommodation of wall");
    prm.declare_entry("real young modulus wall", "0.", Patterns::Double(),
                      "Real Young's modulus of wall");

    prm.declare_entry("thermal conductivity gas", "0.01", Patterns::Double(),
                      "Thermal conductivity of interstitial gas");
    prm.declare_entry("specific heat gas", "1000", Patterns::Double(),
                      "Specific heat of interstitial gas");
    prm.declare_entry("dynamic viscosity gas", "1.e-5", Patterns::Double(),
                      "Dynamic viscosity of interstitial gas");
    prm.declare_entry("specific heats ratio gas", "1", Patterns::Double(),
                      "Specific heats ratio of interstitial gas");
    prm.declare_entry("molecular mean free path gas", "68.e-9",
                      Patterns::Double(),
...
void LagrangianPhysicalProperties::parse_parameters(ParameterHandler &prm) {
  prm.enter_subsection("lagrangian physical properties");
  initialize_containers(
      particle_average_diameter, particle_size_std, distribution_type,
      particle_custom_diameter, particle_custom_probability,
      seed_for_distributions, number, density_particle, youngs_modulus_particle,
      poisson_ratio_particle, restitution_coefficient_particle,
      friction_coefficient_particle,
      rolling_viscous_damping_coefficient_particle,
      rolling_friction_coefficient_particle, surface_energy_particle,
      hamaker_constant_particle, thermal_conductivity_particle,
      specific_heat_particle, microhardness_particle, surface_slope_particle,
      surface_roughness_particle, thermal_accommodation_particle,
  ...
  g = value_string_to_tensor<3>(prm.get("g"), prm.get_double("gy"),
                                prm.get_double("gz"));

  particle_type_number = prm.get_integer("number of particle types");

  for (unsigned int id = 0; id < particle_type_number; ++id) {
    prm.enter_subsection("particle type " + Utilities::int_to_string(id, 1));
  ...
  restitution_coefficient_wall = prm.get_double("restitution coefficient wall");
  ...
  rolling_viscous_damping_wall = prm.get_double("rolling viscous damping wall");
  ...
  molecular_mean_free_path_gas = prm.get_double("molecular mean free path gas");

  prm.leave_subsection();
}

void LagrangianPhysicalProperties::declareDefaultEntry(ParameterHandler &prm) {
  prm.declare_entry("size distribution type", "uniform",
                    Patterns::Selection("uniform|normal|custom"),
                    "Particle size distribution"
                    "Choices are <uniform|normal|custom>.");
  prm.declare_entry("diameter", "0.001", Patterns::Double(),
                    "Particle diameter");
  prm.declare_entry("standard deviation", "0", Patterns::Double(),
                    "Particle size standard deviation");
  prm.declare_entry("custom diameters", "0.001 , 0.0005",
                    Patterns::List(Patterns::Double()),
                    "Diameter values for a custom distribution");
  prm.declare_entry("custom volume fractions", "0.6 , 0.4",
                    Patterns::List(Patterns::Double()),
                    "Probabilities of each diameter of the custom distribution "
                    "based on the volume fraction");
  prm.declare_entry(
      "random seed distribution", "1", Patterns::Integer(),
      "Seed for generation of random numbers for the size distribution");
  prm.declare_entry("number of particles", "0", Patterns::Integer(),
                    "Number of particles of this type");
  prm.declare_entry("density particles", "1000", Patterns::Double(),
                    "Particle density");
  prm.declare_entry("young modulus particles", "1000000", Patterns::Double(),
                    "Particle Young's modulus");
  prm.declare_entry("poisson ratio particles", "0.3", Patterns::Double(),
                    "Particle Poisson ratio");
  prm.declare_entry("restitution coefficient particles", "0.1",
                    Patterns::Double(), "Particle restitution coefficient");
  prm.declare_entry("friction coefficient particles", "0.1", Patterns::Double(),
                    "Particle friction coefficient");
  prm.declare_entry("rolling viscous damping particles", "0.1",
                    Patterns::Double(), "Particle rolling viscous damping");
  prm.declare_entry("rolling friction particles", "0.1", Patterns::Double(),
                    "Particle rolling friction");
  prm.declare_entry("surface energy particles", "0.0", Patterns::Double(),
                    "Particle surface energy");
  prm.declare_entry("hamaker constant particles", "4.e-19", Patterns::Double(),
                    "Material Hamaker constant");
  prm.declare_entry("thermal conductivity particles", "1", Patterns::Double(),
                    "Particle thermal conductivity");
  prm.declare_entry("specific heat particles", "1000", Patterns::Double(),
                    "Particle specific heat");
  prm.declare_entry("microhardness particles", "1.e9", Patterns::Double(),
                    "Particle microhardness");
  prm.declare_entry("surface slope particles", "0.1", Patterns::Double(),
                    "Particle surface slope");
  prm.declare_entry("surface roughness particles", "1.e-9", Patterns::Double(),
                    "Particle surface roughness");
  prm.declare_entry("thermal accommodation particles", "0.7",
                    Patterns::Double(), "Particle thermal accommodation");
  prm.declare_entry("real young modulus particles", "0.", Patterns::Double(),
                    "Particle real Young's modulus");
}

void LagrangianPhysicalProperties::parse_particle_properties(
    const unsigned int &particle_type, const ParameterHandler &prm) {
  ...
  if (std::abs(probability_sum - 1.0) > 1.e-5) {
    throw(std::runtime_error("Invalid custom volume fraction. The sum of "
                             "volume fractions should be equal to 1.0 "));
  }
  ...
  if (size_distribution_type_str == "uniform") {
    ...
    throw(std::runtime_error("Invalid size distribution type. Choices are "
                             "<uniform|normal|custom>."));
  }
...
void LagrangianPhysicalProperties::initialize_containers(
    ...
    std::unordered_map<unsigned int, std::vector<double>> &p_custom_probability,
...
template <int dim>
void InsertionInfo<dim>::declare_parameters(ParameterHandler &prm) {
  prm.enter_subsection("insertion info");
  {
    prm.declare_entry("insertion method", "volume",
                      Patterns::Selection("file|list|plane|volume"),
                      "Choosing insertion method. "
                      "Choices are <file|plane|list|volume>.");
    prm.declare_entry("inserted number of particles at each time step", "0",
                      Patterns::Integer(),
                      "Inserted number of particles at each time step");
    prm.declare_entry("insertion frequency", "0", Patterns::Integer(),
                      "Insertion frequency");

    // Removal box:
    prm.declare_entry(
        "remove particles", "false", Patterns::Bool(),
        "State whether particles should be cleared on insertion.");

    prm.declare_entry(
        "removal box points coordinates", "0. , 0. , 0. : 1. , 1. , 1.",
        Patterns::List(Patterns::List(Patterns::Double(), 2, 3, ","), 2, 2,
                       ":"),
        "Coordinates of two points for the removal box (x1, y1, z1 : x2, y2, "
        "z2)");

    // File:
    prm.declare_entry("list of input files", "particles.input",
                      Patterns::List(Patterns::FileName()),
                      "The file name from which we load the particles");

    // Plane:
    prm.declare_entry("insertion plane point", "0., 0., 0.",
                      Patterns::List(Patterns::Double()),
                      "Insertion plane point location");
    prm.declare_entry("insertion plane normal vector", "1., 0., 0.",
                      Patterns::List(Patterns::Double()),
                      "Insertion plane normal vector");
    prm.declare_entry("insertion plane threshold distance", "0.",
                      Patterns::Double(),
                      "If all the vertices of a cell are closer or equal to "
                      "this value, than this cell is in the plane");

    // List:
    prm.declare_entry("list x", "0", Patterns::List(Patterns::Double()),
                      "List of particles x positions");
    prm.declare_entry("list y", "0", Patterns::List(Patterns::Double()),
                      "List of particles y positions");
    prm.declare_entry("list z", "0", Patterns::List(Patterns::Double()),
                      "List of particles z positions");
    prm.declare_entry("list velocity x", "0",
                      Patterns::List(Patterns::Double()),
                      "List of initial velocities x");
    prm.declare_entry("list velocity y", "0",
                      Patterns::List(Patterns::Double()),
                      "List of initial velocities y");
    prm.declare_entry("list velocity z", "0",
                      Patterns::List(Patterns::Double()),
                      "List of initial velocities z");
    prm.declare_entry("list omega x", "0.", Patterns::List(Patterns::Double()),
                      "List of initial omega x");
    prm.declare_entry("list omega y", "0.", Patterns::List(Patterns::Double()),
                      "List of initial omega y");
    prm.declare_entry("list omega z", "0.", Patterns::List(Patterns::Double()),
                      "List of initial omega z");
    prm.declare_entry("list diameters", "-1.0",
                      Patterns::List(Patterns::Double()), "List of diameters");
    prm.declare_entry("list temperatures", "0.",
                      Patterns::List(Patterns::Double()),
                      "List of initial temperatures");
    // Volume:
    prm.declare_entry(
        "insertion direction sequence", "0,1,2",
        Patterns::List(Patterns::Integer(), 2, 3),
        "Direction of particle insertion for the volume insertion method");
    prm.declare_entry(
        "insertion box points coordinates", "0. , 0. , 0. : 1. , 1. , 1.",
        Patterns::List(Patterns::List(Patterns::Double(), 2, 3, ","), 2, 2,
                       ":"),
        "Coordinates of two points for the insertion box (x1, y1, z1 : x2, y2, "
        "z2)");
    prm.declare_entry("insertion distance threshold", "1.", Patterns::Double(),
                      "Distance threshold");

    // Volume or plane:
    prm.declare_entry("insertion maximum offset", "1.", Patterns::Double(),
                      "Maximum position offset when insertion of particles");
    prm.declare_entry(
        "insertion prn seed", "1", Patterns::Integer(),
        "Pseudo-random number seed used to generate the position offsets");
    prm.declare_entry("initial velocity", "0.0, 0.0, 0.0",
                      Patterns::List(Patterns::Double()),
                      "Initial velocity (x, y, z)");
    prm.declare_entry("initial angular velocity", "0.0, 0.0, 0.0",
                      Patterns::List(Patterns::Double()),
...
template <int dim>
void InsertionInfo<dim>::parse_parameters(ParameterHandler &prm) {
  prm.enter_subsection("insertion info");
  {
    ...
    const std::vector<std::string> removal_box_point_coordinates_list(
        Utilities::split_string_list(prm.get("removal box points coordinates"),
                                     ":"));
...
template <int dim>
void ModelParameters<dim>::declare_parameters(ParameterHandler &prm) {
  prm.enter_subsection("model parameters");
  {
    prm.enter_subsection("load balancing");
    {
      prm.declare_entry(
          "load balance method", "none",
          Patterns::Selection(
      ...
      prm.declare_entry(
          "particle weight", "2000", Patterns::Integer(),
          "The particle weight based on a default cell weight of 1000");

      prm.declare_entry("active weight factor", "1.0", Patterns::Double(),
                        "Factor applied on the particle weight in load "
                        "balancing if the cell is active");

      prm.declare_entry("inactive weight factor", "1.0", Patterns::Double(),
                        "Factor applied on the particle weight in load "
                        "balancing if the cell is inactive");
    }
    prm.leave_subsection();

    prm.enter_subsection("contact detection");
    {
      prm.declare_entry("contact detection method", "dynamic",
      ...
      prm.declare_entry("dynamic contact search size coefficient", "0.8",
                        Patterns::Double(),
                        "Security coefficient for dynamic contact detection");

      prm.declare_entry(
          "neighborhood threshold", "1.3", Patterns::Double(),
          "Contact search zone diameter to particle diameter ratio");
    }
    prm.leave_subsection();

    prm.declare_entry(
        "particle particle contact force method", "hertz_mindlin_limit_overlap",
        Patterns::Selection("linear|hertz_mindlin_limit_force|hertz_mindlin_"
                            "limit_overlap|hertz|hertz_JKR|DMT"),
        "Choosing particle-particle contact force model"
        "Choices are "
        "<linear|hertz_mindlin_limit_force|hertz_mindlin_limit_overlap|hertz|"
        "hertz_JKR|DMT>.");

    prm.declare_entry("particle wall contact force method", "nonlinear",
    ...
    {
      prm.declare_entry("enable adaptive sparse contacts", "false",
                        Patterns::Selection("true|false"),
                        "Enable the dynamic search for sparse particle contacts"
                        "Choices are <true|false>.");

      prm.declare_entry(
          "enable particle advection", "false",
          Patterns::Selection("true|false"),
          "Enable the advection of particles with hydrodynamic forces"
          "Choices are <true|false>.");

      prm.declare_entry("granular temperature threshold", "1e-4",
                        Patterns::Double(),
                        "Minimum granular temperature where particle contacts "
                        "are considered");

      prm.declare_entry(
          "solid fraction threshold", "0.4", Patterns::Double(),
          "Maximum solid fraction where particle contacts are considered "
          "no matter the granular temperature");
    }
    prm.leave_subsection();

    prm.declare_entry("disable position integration", "false",
                      Patterns::Selection("true|false"),
...
template <int dim>
void ModelParameters<dim>::parse_parameters(ParameterHandler &prm) {
  prm.enter_subsection("model parameters");
  {
    prm.enter_subsection("adaptive sparse contacts");
    {
    ...
    prm.enter_subsection("load balancing");
    {
      ...
      if (load_balance == "once") {
        ...
        if (sparse_particle_contacts) {
          load_balance_method = LoadBalanceMethod::dynamic_with_sparse_contacts;
          load_balance_threshold = prm.get_double("threshold");
          dynamic_load_balance_check_frequency =
              prm.get_integer("dynamic check frequency");
          ...
          throw(std::runtime_error("Invalid contact detection method: adaptive "
                                   "sparse contacts is not enabled "
                                   "while dynamic_with_sparse_contacts is "
                                   "selected, use dynamic instead"));
        }
    ...
    const std::string ppcf = prm.get("particle particle contact force method");
    if (ppcf == "linear")
    ...
    if (pwcf == "linear")
      ...
      particle_wall_contact_force_method = ParticleWallContactForceModel::JKR;
    else if (pwcf == "DMT")
      particle_wall_contact_force_method = ParticleWallContactForceModel::DMT;
    else {
      throw(std::runtime_error("Invalid particle-wall contact force model "));
    }
    ...
    if (Utilities::MPI::this_mpi_process(MPI_COMM_WORLD) == 0) {
      if (rolling_resistance_torque == "no_resistance")
        std::cout << "Warning, the \"no_resistance\" entry to the \"rolling "
      ...
      if (rolling_resistance_torque == "epsd_resistance")
        std::cout << "Warning, the \"epsd_resistance\" entry to the \"rolling "
                     "resistance torque method\" parameter will be deprecated. "
    ...
    disable_position_integration = prm.get_bool("disable position integration");
  }
  prm.leave_subsection();
}

template <int dim>
void ForceTorqueOnWall<dim>::declare_parameters(ParameterHandler &prm) {
  prm.enter_subsection("boundary forces");
  prm.declare_entry("calculation", "false", Patterns::Bool(),
                    "Enable calculation of forces");
  prm.declare_entry("verbosity", "verbose",
                    Patterns::Selection("quiet|verbose"),
                    "State whether output from solver runs should be printed. "
                    "Choices are <quiet|verbose>.");
  prm.declare_entry("filename", "force", Patterns::FileName(),
  ...
  prm.declare_entry("x", "0", Patterns::Double(),
                    "X coordinate of center of mass");
  prm.declare_entry("y", "0", Patterns::Double(),
                    "Y coordinate of center of mass");
  prm.declare_entry("z", "0", Patterns::Double(),
...
template <int dim>
void ForceTorqueOnWall<dim>::parse_parameters(ParameterHandler &prm) {
  prm.enter_subsection("boundary forces");
...
template <int dim>
void FloatingWalls<dim>::declare_parameters(ParameterHandler &prm) const {
  prm.enter_subsection("floating walls");
  {
    prm.declare_entry("number of floating walls", "0", Patterns::Integer(),
...
template <int dim>
void FloatingWalls<dim>::parse_parameters(ParameterHandler &prm) {
  prm.enter_subsection("floating walls");
  {
...
template <int dim>
void FloatingWalls<dim>::declareDefaultEntry(ParameterHandler &prm) {
...
template <int dim>
void FloatingWalls<dim>::parse_floating_wall(ParameterHandler &prm) {
  prm.enter_subsection("point on wall");
...
void BCDEM::declare_parameters(ParameterHandler &prm) const {
  prm.enter_subsection("DEM boundary conditions");
  {
    prm.declare_entry("number of boundary conditions", "0", Patterns::Integer(),
                      "Number of boundary conditions");

    for (unsigned int counter = 0; counter < DEM_BC_number_max;
         ++counter) { // Example: "boundary condition 0"
...
void BCDEM::parse_parameters(ParameterHandler &prm) {
  prm.enter_subsection("DEM boundary conditions");

  DEM_BC_number = prm.get_integer("number of boundary conditions");

  initialize_containers(boundary_translational_velocity,
                        boundary_rotational_speed, boundary_rotational_vector,
                        point_on_rotation_axis, outlet_boundaries, bc_types);
...
void BCDEM::declareDefaultEntry(ParameterHandler &prm) {
  ...
  prm.declare_entry("speed x", "0.", Patterns::Double(),
                    "Translational boundary speed in x direction");
  prm.declare_entry("speed y", "0.", Patterns::Double(),
                    "Translational boundary speed in y direction");
  prm.declare_entry("speed z", "0.", Patterns::Double(),
                    "Translational boundary speed in z direction");

  prm.declare_entry("rotational speed", "0.", Patterns::Double(),
                    "Rotational boundary speed");

  prm.declare_entry("rotational vector", "1.,0.,0.",
                    Patterns::List(Patterns::Double()),
                    "Rotational vector elements");

  prm.declare_entry("periodic id 0", "0", Patterns::Integer(),
                    "Periodic boundary ID 0");
  prm.declare_entry("periodic id 1", "0", Patterns::Integer(),
                    "Periodic boundary ID 1");

  prm.declare_entry("point on rotational vector", "0, 0, 0",
                    Patterns::List(Patterns::Double()),
                    "Point on the rotational vector");
  prm.declare_entry(
      "periodic direction", "0", Patterns::Integer(),
      "Periodic direction or normal direction of periodic boundary");
}

void BCDEM::parse_boundary_conditions(const ParameterHandler &prm) {
...
void BCDEM::initialize_containers(
...
template <int dim>
void GridMotion<dim>::declare_parameters(ParameterHandler &prm) {
  prm.enter_subsection("grid motion");
  {
    ...
    prm.declare_entry("grid translational velocity x", "0", Patterns::Double(),
                      "grid translational velocity x");
    prm.declare_entry("grid translational velocity y", "0", Patterns::Double(),
                      "grid translational velocity y");
    prm.declare_entry("grid translational velocity z", "0", Patterns::Double(),
                      "grid translational velocity z");

    prm.declare_entry("grid rotational speed", "0", Patterns::Double(),
                      "grid rotational speed");

    prm.declare_entry("grid rotational axis", "0", Patterns::Integer(),
...
template <int dim>
void GridMotion<dim>::parse_parameters(ParameterHandler &prm) {
  prm.enter_subsection("grid motion");
  {
...
void LagrangianPostProcessing::parse_parameters(ParameterHandler &prm) {
  prm.enter_subsection("post-processing");
  {
...
template <int dim>
void FloatingGrid<dim>::declare_parameters(ParameterHandler &prm) {
...
template <int dim>
void FloatingGrid<dim>::parse_parameters(ParameterHandler &prm) {
  prm.enter_subsection("floating grid");
  {
...
template <int dim>
void ParticleRayTracing<dim>::declare_parameters(ParameterHandler &prm) {
  prm.enter_subsection("particle ray tracing");
  {
    // Location of the first photon to be inserted
    prm.declare_entry("starting photon insertion position", "0.,0.,0.",
                      Patterns::List(Patterns::Double()),
    ...
    // first photon.
    prm.declare_entry(
        "insertion unit tensors", "1.,0.,0. : 0., 1., 0. : 0., 0., 1.",
    ...
    prm.declare_entry("number of inserted photons per direction", "1 : 1 : 1",
    ...
    prm.declare_entry("reference displacement vector", "0.,0.,1.",
                      Patterns::List(Patterns::Double()),
                      "Reference displacement vector of each photons.");

    // Insertion location
    prm.declare_entry(
        "photon insertion maximum offset", "0.", Patterns::Double(),
    ...
    prm.declare_entry(
        "photon insertion prn seed", "0", Patterns::Integer(),
        "Pseudo random seed used to generate the offset for each photon "
        "insertion location.");

    // Displacement unit vector
    prm.declare_entry(
        "photon maximum angular offset", "0.", Patterns::Double(),
    ...
    prm.declare_entry("photon angular offset prn seed", "1",
                      Patterns::Integer(),
...
template <int dim>
void ParticleRayTracing<dim>::parse_parameters(ParameterHandler &prm) {
  prm.enter_subsection("particle ray tracing");
  {
    // Location of the first photon to be inserted
    ...
    const std::vector<std::string> step_between_photon_per_direction_strings(
        Utilities::split_string_list(
    ...
    for (int i = 0; i < dim; i++) {
      ...
      n_photons_each_directions.emplace_back(
          Utilities::string_to_double(n_photons_per_directions_strings.at(i)));
    ...
    ref_displacement_tensor_unit = tensor_nd_to_3d(
        value_string_to_tensor<dim>(prm.get("reference displacement vector")));
    ref_displacement_tensor_unit =
        ref_displacement_tensor_unit / ref_displacement_tensor_unit.norm();

    // Insertion offset
    max_insertion_offset = prm.get_double("photon insertion maximum offset");
    prn_seed_photon_insertion = prm.get_integer("photon insertion prn seed");

    // Displacement direction offset
    max_angular_offset = prm.get_double("photon maximum angular offset");
    prn_seed_photon_displacement = prm.get_integer("photon insertion prn seed");
  }
  prm.leave_subsection();
}
