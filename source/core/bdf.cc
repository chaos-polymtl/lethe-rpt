...
Vector<double> bdf_coefficients(const unsigned int p,
...
Vector<double> delta(const unsigned int order, const unsigned int n,
                     const unsigned int j, const Vector<double> &times) {
  if (j == 0) {
