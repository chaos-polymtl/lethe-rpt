...
/**
 * @brief The TestClass tests the non-linear solvers using a simple system of
 * two equations, only one of which is non-linear
 */
...
void test() {
  Parameters::NonLinearSolver params{
      ...
      .kinsol_strategy = Parameters::NonLinearSolver::KinsolStrategy::
          normal_newton, // not used in
                         // this case
      .tolerance = 1e-8,
      .max_iterations = 10,
      .display_precision = 4,
