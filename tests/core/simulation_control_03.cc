...
/**
 * @brief This test checks whether the is_output_iteration behaves correctly for
 * iteration output control and time output control (in the case of constant
 * time step and adaptive time step).
 */
