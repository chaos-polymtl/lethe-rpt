...
/**
 * @brief The PVDHandler class manages the storage of the information required
 * to write pvd file. It is particularly necessary for simulations which must be
 * restarted from checkpoint since it manages the continuity of the pvd output.
 */
class PVDHandler {
public:
  /**
  ...
  void append(double time, const std::string &pvtu_filename) {
