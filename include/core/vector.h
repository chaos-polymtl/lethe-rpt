...
/**
 * @brief Helper function that allows to convert deal.II vectors to Trilinos
 * vectors.
 *
...
void convert_vector_dealii_to_trilinos(
...
/**
 * @brief Helper function that allows to convert Trilinos vectors to deal.II
 * vectors.
 *
 * @tparam number Abstract type for number across the class (i.e., double).
 ...
 */
template <typename number>
void convert_vector_trilinos_to_dealii(
