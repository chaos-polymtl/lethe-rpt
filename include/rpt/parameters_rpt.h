...
struct RPTTuningParameters {
  ...
  enum class CostFunctionType { larachi, l1, l2 };
...
struct RPTReconstructionParameters {
  ...
  bool verbose_clock; // Allow to show total wallclock time elapsed since start
...
struct RPTFEMReconstructionParameters {
  ...
  // position
  enum class FEMCostFunction { absolute, relative };
  ...
  enum class FEMSearchType { local, global };
  FEMSearchType search_type;

  unsigned int search_proximity_level; // level of proximity of the search scope
