...
[Lethe repository](https://github.com/chaos-polymtl/lethe) up to
...
by the [CHAOS laboratory](https://www.chaos-lab.ca/). 
Lethe is based on [deal.II](https://www.dealii.org/), a finite element library.
